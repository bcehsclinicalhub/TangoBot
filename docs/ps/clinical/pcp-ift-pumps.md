...
With the new EMALB Scope Expansion for PCP’s, there are more options for equipment, medications, and procedures. [High-Risk Hazards Field Support Guide](https://intranet.bcehs.ca/ce/pulse/user/teams/department/conversation_site_page?project_id=48&page_id=347&lang=ENG){:target="_blank .external-link} and [BCEHS OHS 180.1 Search and Rescue Situations](https://shop.healthcarebc.ca/phsa/BCEHS/Clinical%20Operations/C-04-12-85214.pdf){:target="_blank .external-link}.  
