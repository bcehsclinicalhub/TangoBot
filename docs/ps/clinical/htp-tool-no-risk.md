---
title: High Threat Pathogen Tool
policy_id: 
version: 1.0
status: Active
...
<div class="card-grid-3">
  ...
  <!-- Column 1: Result (Green) -->
  <div class="status-card card-green">
    <h4>Result:</h4>
    <p>Action as <strong>NO HTP RISK</strong></p>
  </div>

  <!-- Column 2: Action (Green) -->
  <div class="status-card card-green">
    <h4>Action:</h4>
    <p>Provide recommendation of contact/droplet PPE as appropriate.</p>
    <br>
    <p>Recommend conveyance to Type 1 receiving facility (pre-alert as required).</p>
    <br>
    <p>All hospitals in British Columbia are considered Type 1 Receiving Facilities.</p>
  </div>

  <!-- Column 3: Advice (Green) -->
  <div class="status-card card-green">
    <h4>Advice:</h4>
    <p>Despite no high-threat pathogen or risk of infection being identified, contact crew to discuss case as appropriate.</p>
  </div>
...
[Public Health Agency of Canada Known Diseases and Conditions](https://www.canada.ca/en/public-health/services/diseases.html){:target="_blank .external-link}

[Public Health Agency of Canada Known Infectious Diseases and Conditions](https://www.canada.ca/en/public-health/services/infectious-diseases.html){:target="_blank .external-link}

[Government of Canada Travel Health Notices](https://travel.gc.ca/travelling/health-safety/travel-health-notices){:target="_blank .external-link}
