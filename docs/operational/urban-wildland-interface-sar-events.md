---
title: Urban-Wildland Interface SAR Events DST
policy_id: 
version: 1.0
status: Active
...
As defined in the [ProMapp prcoess](https://ca.promapp.com/bcehs/Process/Minimode/Permalink/IBOT9mqJnCRwh24gDQ1Nb){:target="_blank .external-link-button}, the PS will receive a dispatch SIG and CliniCall consult for all Urban-Wildland events where helicopters are being utilized, and BCEHS personnel are on scene (i.e., not staged at separate LZ) for further safety direction.
...
**SAFETY ALERT** Urban-Interface SAR. Stage >50m (160ft) from hoist / landing zone as directed and conduct scene safety assessment. Don PPE (helmet, eye protection and high-vis vest) and switch ONE portable radio to PEPCORD 1. If any safety concerns, contact Paramedic Specialist at (604-829-4099). Review handbook for more information.
Note that a pre-populated safety remark will be added to the drop-down during the next CAD update in early 2024.
...
•Eye protection (BCEHS helmets have integrated visor).
•Hearing protection.
